    ...
    public class AccountManagerController : ApiController
    {
        ...
        public AccountUserViewModel getAccounts()
        {
            ...
            if (currentuser != null) {
                ...
                {
                    var  msg = new HttpResponseMessage(HttpStatusCode.OK) { ReasonPhrase = "There are no accounts to manage for this user " };
                    throw new HttpResponseException(msg);
                }
                return CurrnetUserPortfoliio;
            }
            var msg1 = new HttpResponseMessage(HttpStatusCode.BadRequest) { ReasonPhrase = "User is not an account manager " };
